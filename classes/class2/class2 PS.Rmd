...
knitr::opts_knit$set(root.dir = "/Users/paulasamide/Desktop/AU/semester 2/methods/resources")
...
A: The function of a for loop is to run a block of code on each element in a sequence. A while loop runs a block of code as long as a specified condition is being met.
...
while(some_number<20){
  print("the nr is below 20, so I still run!")
...
I did that but didn't save it -> just look it up in the book.
...
basketball <- function(){ 
#### LOOK @ FIRST PART OF THE SOLUTION    
...
#### THIS PART IS ADVANCED (DO EVERYTHING BEFORE 5.8)
