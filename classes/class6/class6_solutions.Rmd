...
[Solutions for exercises A-C are uploaded in pdf.]
...
1. $$A = \begin{pmatrix} 4 & 7 \\ 2 & 6 \end{pmatrix}$$
2. $$B = \begin{pmatrix} 1 & -5 \\ 3 & 2 \end{pmatrix}$$
3. $$C = \begin{pmatrix} -3 & 4 \\ 5 & -2\end{pmatrix}$$

### Ex. A2. Determinants of 3x3 Matrices
Calculate the determinants for the following 3x3 matrices:

1. $$E = \begin{pmatrix} 6 & 1 & 1 \\ 4 & -2 & 5 \\ 2 & 8 & 7 \end{pmatrix}$$
2. $$F = \begin{pmatrix} 0 & 9 & -4 \\ 5 & 3 & 2 \\ 1 & 0 & 8 \end{pmatrix}$$
3. $$G = \begin{pmatrix} 7 & 3 & 1 \\ 2 & 6 & 4 \\ 0 & 2 & 8 \end{pmatrix}$$

## B. Finding the orthogonal vector

### Ex. B1. Find a vector orthogonal to each of v1 and v2:
1. $$\mathbf{v}_1 = \begin{pmatrix} 2 \\ 3 \end{pmatrix}, \mathbf{v}_2 = \begin{pmatrix} -1 \\ 4 \end{pmatrix}$$
...
1. $$M = \begin{pmatrix} 4 & 7 \\ 2 & 6 \end{pmatrix}$$
2. $$N = \begin{pmatrix} 1 & -5 \\ 3 & 2 \end{pmatrix}$$
3. $$O = \begin{pmatrix} -3 & 4 \\ 5 & -2 \end{pmatrix}$$

## D. Rank and trace
### D1. Describe the difference between full rank and short rank
- **Full Rank**: A matrix is of full rank if its rank is equal to the smaller of the number of its rows or columns, indicating all its rows and columns are linearly independent.
- **Short Rank**: A matrix is rank deficient (or short rank) if its rank is less than the smaller of its row and column counts, indicating linear dependence among its rows or columns.
...
Answers:
- **Matrix 1** is full rank because it has no zero determinant.
- **Matrix 2** is short rank due to its zero determinant, indicating linearly dependent rows.
- **Matrix 3** is full rank as all rows and columns are linearly independent.
- **Matrix 4** is short rank because of linearly dependent rows.
- **Matrix 5** is full rank, being the identity matrix.
- **Matrix 6** is short rank, having linearly dependent rows and columns.
